      ...
      <div className="p-6 max-w-3xl">
        ...
        <form onSubmit={guardar} className="bg-white rounded-xl border border-gray-100 p-5 mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 mb-2">
            ...
            <div className="text-xs text-gray-400 font-medium">Litros vendidos</div>
          ...
          <div className="border-t border-gray-100 pt-3 mt-3 grid grid-cols-3 gap-2">
            ...
            <div className="text-sm font-medium text-gray-800">{totalLitros().toLocaleString('es-GT', { maximumFractionDigits: 1 })} L</div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="px-3 py-2.5 text-right text-xs text-gray-400 font-normal">Regular (L)</th>
                  <th className="px-3 py-2.5 text-right text-xs text-gray-400 font-normal">Premium (L)</th>
                  <th className="px-3 py-2.5 text-right text-xs text-gray-400 font-normal">Diesel (L)</th>
